  ...
  const calculatePricing = async () => {
    ...
    try {
      const response = await fetch(
        'http://10.171.84.121:5000/api/v0/seller/product/price-calculation',
        {
          method: 'POST',
          headers: {
...
export const ProductForm: React.FC = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('http://10.171.84.121:5000/api/v0/categories');
    ...
    try {
      ...
      for (let i = 0; i < uploads.length; i++) {
        ...
        const res = await fetch(
          'http://10.171.84.121:5000/api/v0/upload/get-upload-url',
          {
            method: 'POST',
  ...
  const handleSubmit = async () => {
    ...
    const response = await fetch(
      'http://10.171.84.121:5000/api/v0/seller/forms/categories/products',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
